...
#
# The ONDEWO T2S (Text-to-Speech) gRPC client for PHP. There is no hand-written
# transport layer here: the whole client surface is generated from the .proto definitions of
# ondewo-t2s-api by the ondewo-proto-compiler's `ondewo-php-proto-compiler` image, and the
